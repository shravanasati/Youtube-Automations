...
import validators
from os import getcwd, chdir, rename, mkdir
...
class YouTubeDownloader():
    ...
    def show_progress(self, filesize: int):
        """
        ...
        with tqdm(total=100) as pbar:
            while size_on_disk < filesize:
                ...
                pbar.update(float(f"{ratio:.2f}"))

        # changing extension to mp3 if audio
        if self.type == "audio":
            rename(original_path, join_path(
                getcwd(), self.video_title + ".mp3"))
            self.format = ".mp3"
    ...
    def download_video(self, resolution: str = "720p"):
        ...
        try:
            ...
            resolutions = {"2160p": 313, "1440p": 271, "1080p": 299,
                           "720p": 22, "480p": 135, "360p": 18, "240p": 133, "144p": 160}
            ...
            while True:
                ...
                print(
                    f"{resolution} resolution not available for this video, switching to {next_res} resolution.")
        ...
        while True:
            try:
                ...
                new_folder_name = join_path(
                    filepath, self.playlist_name) + "" + random_choice(alphabets)
                print(
...
if __name__ == "__main__":
    ...
    playlist_or_video = int(
        input("What to download? \n 1. Video \n 2. Playlist \n"))
    ...
    if playlist_or_video == 1:
        ...
        try:
            format = int(
                input("What do you want to download from the video:\n 1. Audio \n 2. Video \n"))
        except ValueError:
            print("Invalid input!")
        ...
        url = input(
            "Enter the playlist url for the playlist you want to download: ")
